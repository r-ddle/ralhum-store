...
const brandDetails = [
  {
    ...
    products: [
      ...
      { name: "Cricket Balls", description: "Match and practice balls meeting international standards" },
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Training Equipment", description: "Cones, tackle bags, and skill development tools" },
  ...
  },
  {
    ...
    tagline: "Premium Racquet Sports Equipment",
    description:
      "Dunlop has been a driving force in racquet sports for over a century. From Wimbledon courts to local clubs, our rackets and balls deliver performance and reliability.",
    image: "/placeholder.svg?height=400&width=600",
    color: "from-[#FF3D00] to-[#003DA5]",
    icon: Trophy,
    achievements: [
      "Used at Major Tournaments",
      "Professional Player Choice",
      "Century of Innovation",
      "Global Sports Recognition",
    ],
    products: [
      { name: "Tennis Rackets", description: "Professional and recreational tennis rackets" },
      { name: "Squash Rackets", description: "High-performance squash equipment" },
      { name: "Tennis Balls", description: "Tournament and practice tennis balls" },
      { name: "Accessories", description: "Strings, grips, and maintenance equipment" },
    ],
    featured: false,
    slug: "dunlop",
  },
  {
    ...
    tagline: "Official Wimbledon Ball Supplier",
    description:
      "Slazenger's rich heritage spans over 140 years, including being the official ball supplier for Wimbledon. We provide quality equipment across multiple sports categories.",
    image: "/placeholder.svg?height=400&width=600",
    color: "from-[#AEEA00] to-[#FF3D00]",
    icon: Award,
    achievements: [
      "Official Wimbledon Supplier",
      "140+ Years of Heritage",
      "Multi-Sport Excellence",
      "Trusted by Champions",
    ],
    products: [
      { name: "Tennis Equipment", description: "Rackets, balls, and court accessories" },
      { name: "Cricket Gear", description: "Bats, protective equipment, and accessories" },
      { name: "Training Equipment", description: "Multi-sport training and fitness gear" },
      { name: "Accessories", description: "Bags, apparel, and maintenance equipment" },
    ],
    featured: false,
    slug: "slazenger",
  },
  ...
  return (
    <main className="min-h-screen pt-16 bg-white dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">
              As Sri Lanka's exclusive distributor, we bring you authentic equipment from the world's most trusted and
              respected sports brands. Each partnership represents decades of excellence and innovation.
            </p>

            <div className="flex flex-wrap justify-center gap-4 mt-8">
              {brandDetails.map((brand) => (
                <Badge key={brand.name} className="bg-white/10 text-white px-4 py-2 font-bold border border-white/20">
                  {brand.name}
                </Badge>
              ))}
            </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="bg-[#FF3D00] text-white px-6 py-2 text-sm font-bold mb-4">FLAGSHIP PARTNERSHIPS</Badge>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our flagship partnerships with industry leaders, bringing you the finest sports equipment available in Sri
              Lanka.
            </p>
          </div>
              ...
              return (
                ...
                >
                    ...
                    <div className="relative overflow-hidden rounded-2xl">
                      ...
                      <div className="absolute bottom-6 left-6 right-6">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <Badge className="bg-white/20 text-white border-white/30">{brand.heritage}</Badge>
                        </div>
                  ...
                  <div className={!isEven ? "lg:col-start-1 lg:row-start-1" : ""}>
                    <Badge className="bg-[#AEEA00] text-[#1A1A1A] mb-4 font-bold">{brand.category}</Badge>
                    <h3 className="text-3xl md:text-4xl font-black text-[#1A1A1A] dark:text-white mb-4">
                      {brand.name}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 text-lg mb-6 leading-relaxed">{brand.description}</p>
                    ...
                    <div className="space-y-3 mb-8">
                      <h4 className="font-bold text-[#003DA5] dark:text-[#4A90E2] mb-3">PRODUCT CATEGORIES:</h4>
                      {brand.products.slice(0, 3).map((product) => (
                        <div key={product.name} className="border-l-4 border-[#AEEA00] pl-4">
                          <h5 className="font-bold text-gray-800 dark:text-gray-200">{product.name}</h5>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="bg-[#003DA5] text-white px-6 py-2 text-sm font-bold mb-4">ADDITIONAL PARTNERSHIPS</Badge>
            <h2 className="text-4xl md:text-5xl font-black text-[#1A1A1A] dark:text-white mb-6">
              MORE TRUSTED
                      ...
                      <div className="space-y-2 mb-6">
                        {brand.products.slice(0, 2).map((product) => (
                          <div key={product.name} className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-700 dark:text-gray-300 font-medium">{product.name}</span>
                          </div>
                        ))}
                      </div>
      ...
      <section className="py-20 bg-[#1A1A1A] dark:bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="bg-[#FFD700] text-[#1A1A1A] px-6 py-2 text-sm font-bold mb-4">EXCLUSIVE ADVANTAGES</Badge>
            ...
            {[
              {
                ...
                description: "Official and exclusive distributor status for all major brands in Sri Lanka",
              },
              {
                icon: Trophy,
                title: "Authentic Guarantee",
                description: "100% authentic products with full manufacturer warranties and support",
              },
              {
                icon: Globe,
              ...
              },
              {
                ...
                description: "Expert consultation and after-sales support for all your sporting needs",
              },
            ].map((advantage, index) => {
      ...
      <section className="py-16 bg-gradient-to-r from-[#003DA5] to-[#FF3D00] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contact us today to learn more about our exclusive brand partnerships and find the perfect equipment for
            your needs.
          </p>
