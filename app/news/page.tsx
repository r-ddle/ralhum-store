...
const featuredNews = [
  ...
  {
    id: 2,
    title: "25 Years of Excellence: Celebrating Ralhum's Silver Jubilee",
    excerpt:
      "Looking back at 25 incredible years of serving Sri Lanka's sports community and looking forward to an even brighter future.",
    content:
      "From our humble beginnings in 1996 to becoming Sri Lanka's #1 sports equipment distributor, this milestone represents decades of dedication to athletic excellence.",
  ...
  {
    id: 3,
    title: "New Gray-Nicolls Cricket Collection Now Available",
    excerpt:
      "The latest Gray-Nicolls cricket equipment has arrived, featuring cutting-edge technology and traditional craftsmanship.",
    content:
      "This new collection represents the pinnacle of cricket equipment design, combining 165+ years of heritage with modern innovation.",
...
const allNews = [
  ...
  {
    id: 5,
    title: "Molten Basketball Initiative Supports Youth Development",
    excerpt:
      "Our partnership with local schools brings professional-grade Molten basketballs to young athletes across the country.",
    content:
      "This initiative aims to develop basketball talent at the grassroots level using the same equipment used in international competitions.",
    category: "Company Updates",
    date: "2024-01-03",
  ...
  {
    id: 6,
    title: "The Future of Sports Equipment: Technology Trends 2024",
    excerpt:
      "Exploring how technology is revolutionizing sports equipment design and performance across all major sports categories.",
    content:
      "From smart sensors to advanced materials, the sports equipment industry is experiencing rapid technological advancement.",
